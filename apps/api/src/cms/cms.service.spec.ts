...
describe('CmsService', () => {
  ...
  describe('findAllContents', () => {
    ...
    it('게시된 콘텐츠 목록을 반환한다', async () => {
      ...
      const result = await service.findAllContents(tenantId, {} as CmsContentQueryDto);
    ...
    it('페이지네이션을 적용한다', async () => {
      ...
      const result = await service.findAllContents(tenantId, { page: 2, limit: 10 });
  ...
  describe('findOneContent', () => {
    ...
    it('콘텐츠 상세를 반환한다', async () => {
      ...
      prisma.content.update.mockResolvedValue({ ...mockContent, viewCount: 11 });
  ...
  describe('findFaqs', () => {
    const mockFaqs = [
      { id: 'faq-1', type: 'FAQ', category: 'buy', title: 'Q1', answer: 'A1', sortOrder: 0 },
      { id: 'faq-2', type: 'FAQ', category: 'buy', title: 'Q2', answer: 'A2', sortOrder: 1 },
      { id: 'faq-3', type: 'FAQ', category: 'sell', title: 'Q3', answer: 'A3', sortOrder: 0 },
    ];
  ...
  describe('findBanners', () => {
    const mockBanners = [
      { id: 'banner-1', title: '배너1', position: 'MAIN_TOP', isActive: true, sortOrder: 0 },
      { id: 'banner-2', title: '배너2', position: 'MAIN_TOP', isActive: true, sortOrder: 1 },
    ];
